...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {   81000, HFPLL, 0, 0x00 },  900000, 1050000, 1 },
	[1]  = { {  162000, HFPLL, 2, 0x0C },  925000, 1050000, 2 },
	[2]  = { {  270000, HFPLL, 2, 0x14 },  950000, 1050000, 2 },
	[3]  = { {  384000, PLL_8, 2, 0x1C }, 1050000, 1050000, 1 },
